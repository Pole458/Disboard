...
namespace ConnectFour
{
    ...
    const BitBoard k2 =                 0b0000000111111100000000000000000000011111110000000UL;  // 010 0 010
    const BitBoard k3 = 34093383680UL;      // 001 0 100
    const BitBoard k4 = 266338304Ul;        // 000 1 000
    const BitBoard left =               0b1111111111111111111110000000000000000000000000000UL;
    const BitBoard right =              0b0000000000000000000000000000111111111111111111111UL;
